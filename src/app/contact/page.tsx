      ...
      <div className="pt-20 min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        <div className="max-w-6xl mx-auto px-4 py-16">
          <form onSubmit={handleSubmit} className="grid lg:grid-cols-2 gap-8 lg:gap-16 mb-16">
            ...
            <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 1.4 }} className="space-y-8 order-1 lg:order-2">
              {/* Quick Contact */}
          ...
          <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 1.8 }} className="bg-white/60 backdrop-blur-lg rounded-3xl p-6 sm:p-8 lg:p-12 border border-white/20 shadow-xl">
            {/* ... */}
          </motion.div>
        </div>
      </div>
