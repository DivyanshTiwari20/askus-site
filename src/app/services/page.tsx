    ...
    >
      ...
      <div className="absolute inset-0 p-6 sm:p-8 flex flex-col justify-between text-white">
        <div className="flex justify-between items-start">
          <div
            className={`p-3 sm:p-4 bg-white/20 backdrop-blur-sm rounded-2xl transition-all duration-500 ${
              isExpanded && isMobile
                ? 'bg-white text-gray-900 scale-110 rotate-12'
                : 'group-hover:bg-white group-hover:text-gray-900 group-hover:scale-110 group-hover:rotate-12'
            }`}
          >
            <Icon className="w-6 h-6 sm:w-8 sm:h-8" />
          </div>
          <div
            className={`p-2 sm:p-3 bg-white/20 backdrop-blur-sm rounded-full transition-all duration-500 delay-200 ${
              isExpanded && isMobile
        ...
        >
          ...
          <p
            className={`text-white/80 text-sm sm:text-base leading-relaxed transition-all duration-500 transform ${
              isExpanded && isMobile
        ...
        <div
          className={`lg:hidden absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white/60 text-xs transition-all duration-300 ${
      ...
      <div
        className={`absolute top-2 right-2 w-2 h-2 bg-white/40 rounded-full transition-all duration-500 ${
          isExpanded && isMobile
  ...
  const services = [
    {
      ...
      description:
        'Cinematic storytelling that captivates audiences and drives engagement through professional-grade content creation.',
    ...
    },
    {
      ...
      description:
        'Strategic social presence that builds communities, amplifies your brand voice, and converts followers into customers.',
    ...
    },
    {
      ...
      description:
        'Beautiful, functional digital experiences that combine stunning aesthetics with seamless user interactions.',
    ...
    },
    {
      ...
      description:
        'Data-driven strategies that boost your search visibility and drive qualified organic traffic to your business.',
    ...
    },
    {
      ...
      description:
        'Direct customer engagement through personalized messaging that builds relationships and drives conversions.',
    ...
    },
    {
      ...
      description:
        'Targeted campaigns that nurture leads, build loyalty, and generate revenue through personalized communication.',
