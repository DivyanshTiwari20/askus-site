...
const ValuesAndFooter = () => {
  const values = [
    {
      number: "001",
      title: "Customer-centric",
      description: "Need help or guidance? We're here for you every step of the way.",
      icon: "👥"
    },
    {
      number: "002", 
      title: "Innovation",
      description: "Count on us for support, guidance, and teamwork at all times.",
      icon: "💡"
    },
    {
      number: "003",
      title: "Excellence", 
      description: "Get in touch with us for assistance, guidance, and teamwork.",
      icon: "⭐"
    },
    {
      number: "004",
      title: "Communicate",
      description: "Count on us for support, guidance, and collaboration.",
      icon: "💬"
    }
  ];
  ...
  // Improved animation variants for smoother appearance and hover
    ...
    <div className="w-full">
      ...
      >
        <div className="max-w-6xl mx-auto px-6">
          <motion.div className="text-center mb-16" variants={footerItemVariants}>
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Our core values</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Fully functional dolor sit amet, consectetur risuse rutile et imperdiet dolores officin
              taccusantium.
            </p>
          </motion.div>
          ...
          >
            {values.map((value, index) => (
              <motion.div
                key={index}
                className="text-center group bg-white rounded-xl p-8 border border-gray-200 shadow-lg transition-all duration-300"
      ...
      >
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            {/* Logo and Newsletter */}
            <motion.div className="lg:col-span-2" variants={footerItemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
            ...
            {Object.entries(footerLinks).map(([category, links], categoryIndex) => (
              <motion.div key={category} variants={footerItemVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
